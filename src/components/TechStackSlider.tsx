        ...
        >
          <div className="flex gap-16 w-max py-4">
            ...
            {[...techStack, ...techStack, ...techStack, ...techStack].map((tech, index) => (
              ...
              >
                <div className="flex w-20 h-20 rounded-2xl bg-card/0.5 backdrop-blur-sm border border-border/0 flex items-center justify-center mb-4 p-4 group-hover:scale-100 group-hover:shadow-glow group-hover:border-primary/10 transition-all duration-110">
                  <img 
                    src={tech.logo} 
                    alt={tech.name}
